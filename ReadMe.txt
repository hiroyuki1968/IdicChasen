========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : IdicChasen
========================================================================


AppWizard が生成した IdicChasen には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには IdicChasen を構成している各ファイルの概要説明が含まれています。
...
IdicChasen.h
    ...
    みます） をインクルードし、また CIdicChasenApp アプリケーションクラスを宣
    言します。

IdicChasen.cpp
    このファイルは CIdicChasenApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\IdicChasen.ico
    ...
    ルです。このアイコンはリソース ファイル IdicChasen.rc によってインクルード
    されます。
...
IdicChasenDlg.h, IdicChasenDlg.cpp - ダイアログ
    これらのファイルは CIdicChasenDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な IdicChasen.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) IdicChasen.pch 
